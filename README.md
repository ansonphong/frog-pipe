...
- **Python** (`matte/`) — recolor, cutout, color knockout, despeckle  
...
```bash
python3 matte/recolor_svg.py icon.svg             # white fills (default), overwrites
python3 matte/recolor_png.py sprite.png
...
Default **overwrites**. Flags (`--new`, `--recursive`, `--color`, `--gamma`, …): **`matte/README.md`**.

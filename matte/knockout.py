...
Usage:
  ...
  python knockout.py path/to/file.png --silhouette # key black; keep greys; blur 4 then levels 112–128
...
# Pulled in: window 112–128 (±8 ending at the old mid) so the edge chokes.
DEFAULT_BLUR = 4.0
DEFAULT_LO = 112.0
DEFAULT_HI = 128.0
...
def knockout_image(
    ...
    *,
    ...
    Then blur the matte and input-levels it (default blur 4, lo 112, hi 128).
    --color unused.
    """
...
def main(argv: list[str] | None = None) -> int:
    ap = argparse.ArgumentParser(
        description=(
            ...
            "then blur the matte and levels it (default blur 4, 112–128). "
    ...
    ap.add_argument(
        ...
        default=None,
        metavar="N",
        help="Silhouette only: levels black point on the blurred matte 0–255 (default 112)",
    )
    ap.add_argument(
        "--hi",
        type=float,
        default=None,
        metavar="N",
        help="Silhouette only: levels white point on the blurred matte 0–255 (default 128)",
    )
